    ...
    <Navbar style={{background: "ghostwhite"}} expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        >
          ...
          <Nav.Link style={{font: "Roboto"}} eventKey="/React-Portfolio/portfolio" href="/React-Portfolio/portfolio.js">Portfolio</Nav.Link>
          <Nav.Link style={{font: "Roboto"}} eventKey="/React-Portfolio/contact" href="/React-Portfolio/contact.js">Contact</Nav.Link>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  )
