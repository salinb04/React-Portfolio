    ...
    <Navbar style={{background: "ghostwhite"}} expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        >
          ...
          <Nav.Link style={{font: "Roboto"}} eventKey="/React-Portfolio/portfolio" href="/portfolio">Portfolio</Nav.Link>
          <Nav.Link style={{font: "Roboto"}} eventKey="/React-Portfolio/contact" href="/contact" >Contact</Nav.Link>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  )
